export const SharePoster = 'http://cdn.actoken.cn/sharePoster.jpeg'

const { safeAreaInsets, safeArea } = uni.getWindowInfo()

export const SafeareaTop = safeAreaInsets.top

export const TabbarHeight = 50 + safeAreaInsets.bottom

export const NavbarHeight = 44 + safeAreaInsets.top

export const UsableHeight = safeArea.height - NavbarHeight
